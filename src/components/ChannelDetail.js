       ...
       <div className="mt-3">
        ...
        <div className="flex md:items-center justify-between gap-4">
                    ...
                    <div className="flex flex-col md:flex-row gap-3 md:items-center ">
                        ...
                        <button className="bg-black text-white hover:bg-gray-800 md:ml-4 p-2 px-4 rounded-3xl " onClick={()=>{
                            setIsSubscribed(!isSubscribed);
                        }}>{isSubscribed ? "Unsubscribe" : "Subscribe"}</button>
                    </div>
                    {/* right part */}
                    <div  className="flex md:w-full w-7/12 flex-wrap md:gap-2">
                        ...
                        <button className="bg-gray-100 hover:bg-gray-200 transition-all duration-400 p-2 px-4 rounded-3xl " >Clip<i class="fa-solid fa-scissors px-1"></i></button>
                        <button className="bg-gray-100 hover:bg-gray-200 transition-all duration-400  p-2 px-4 rounded-3xl " >Download<i class="fa-solid fa-download px-1"></i></button>
                        <button className="bg-gray-100 hover:bg-gray-200 transition-all duration-400  p-2 px-4 rounded-3xl " >Share  <i class="fa-solid fa-share"></i></button>
                    </div>
                </div>
       </div>
    )
